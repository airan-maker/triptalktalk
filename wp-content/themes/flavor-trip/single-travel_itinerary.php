        ...
        <div class="itinerary-content">
            <header class="itinerary-header">
                ...
                <div class="itinerary-meta-bar">
                    ...
                    ?>
                    <?php if ($duration) : ?>
                        <span class="meta-item"><span class="meta-icon">?ìÖ</span> <?php echo esc_html($duration); ?></span>
                    <?php endif; ?>
                    <?php if ($difficulty) : ?>
                        <span class="meta-item"><span class="meta-icon">‚≠?/span> <?php echo esc_html(ft_get_difficulty_label($difficulty)); ?></span>
                    <?php endif; ?>
                    <?php if ($price) : ?>
                        <span class="meta-item"><span class="meta-icon">?í∞</span> <?php echo esc_html(ft_get_price_label($price)); ?></span>
                    <?php endif; ?>
                    <span class="meta-item"><span class="meta-icon">?ìù</span> <?php echo esc_html(get_the_date()); ?></span>
                </div>
            </header>
            ...
            <?php if (!empty($days)) : ?>
                <section class="itinerary-days" id="daily-itinerary">
                    <h2 class="section-heading"><?php esc_html_e('?ºÏûêÎ≥??ºÏ†ï', 'flavor-trip'); ?></h2>
                    <div class="timeline">
            ...
            if ($styles && !is_wp_error($styles)) : ?>
                <div class="itinerary-styles">
                    <h3><?php esc_html_e('?¨Ìñâ ?§Ì???, 'flavor-trip'); ?></h3>
                    <div class="tags">
