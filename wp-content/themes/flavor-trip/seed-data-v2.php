            ...
            [
                ...
                'spots'   => [
                    [
                        ...
                        'tip'         => '리조트 입구에서 "시트론 레스토랑 조식 예약"이라고 말하면 통과. 복장 제한 없음. 아이 동반 시 키즈 메뉴 별도 있음.',
                        'lat'         => 16.1197,
                        'lng'         => 108.2678,
                    ],
                    [
                        ...
                        'description' => '다낭에서 가장 포토제닉한 인피니티풀을 배경으로 커피 한 잔. 풀과 바다가 하나로 이어지는 착시 뷰가 인스타 핫플. 에어컨 시원한 실내 또는 풀 바로 옆 야외석 선택 가능.',
                        'duration'    => '1시간',
                    ...
                    [
                        ...
                        'name'        => '풀만 다낭 - 엡론 레스토랑',
                        'cuisine'     => '양식/베트남',
                        'description' => '미케비치가 한눈에 보이는 오픈 테라스 레스토랑. 에어컨 실내석과 바다 바로 앞 야외석 선택 가능. 런치 세트는 애피타이저+메인+디저트+음료 구성으로, 단품 주문 대비 30% 저렴합니다. 베트남 로컬 요리부터 파스타, 스테이크까지 다양한 메뉴 보유.',
                    ...
                    [
                        ...
                        'description' => '다낭 시내 최고층(36층) 루프탑 바. 한강, 용다리, 미케비치가 360도로 펼쳐지는 파노라마 뷰. 낮에는 카페, 저녁에는 클럽 분위기로 변신. 해가 지기 전 방문하면 낮과 밤 뷰를 모두 즐길 수 있음.',
                        'duration'    => '1시간',
                        'tip'         => '오후 2-5시는 카페 타임으로 커피/음료 100,000동(약 5,500원)부터. 저녁 6시 이후는 해피아워로 칵테일 1+1. 드레스코드 없지만 슬리퍼는 입장 불가. 노보텔 건물 36층, 엘리베이터로 바로 올라감.',
                        'lat'         => 16.0610,
                        'lng'         => 108.2236,
                    ],
                    [
                        ...
                        'cuisine'     => '파인다이닝',
                        'description' => '미슐랭 3스타 셰프 Pierre Gagnaire가 감수한 베트남-프렌치 퓨전 레스토랑. 정식 디너는 1인 150만동(약 8만원)이지만, 바 좌석에서 선셋 칵테일+애피타이저 조합이면 파인다이닝 분위기를 1/5 가격에 경험 가능. 19세기 프랑스 식민지풍 인테리어가 인상적.',
                        'menu'        => '시그니처 칵테일 + 트러플 감자튀김 또는 참치 타르타르',
                        'price'       => '300,000동 (약 16,000원)',
                        'wait_tip'    => '일몰 17:30-18:30가 황금 시간. 최소 하루 전 예약 권장.',
                        'tip'         => '드레스코드: 스마트 캐주얼 (반바지, 슬리퍼 불가). 남성은 긴바지+카라 있는 셔츠 권장. 예약 전화: 0236-3988-999',
                        'lat'         => 16.0479,
                        'lng'         => 108.2410,
                    ],
                    [
                        'type'        => 'place',
                        'time'        => '19:00',
                        'name'        => '용다리 (Dragon Bridge) 야경',
                        'description' => '다낭의 랜드마크. 666m 길이의 다리 전체가 용 모양으로, 밤에는 LED 조명으로 색이 바뀜. 매주 토/일 밤 9시에 용 머리에서 불과 물을 뿜는 쇼가 펼쳐지며, 다낭 여행의 하이라이트.',
                        'duration'    => '1시간 30분 (쇼 대기 포함)',
                        'tip'         => '불쇼 명당: 다리 동쪽(용 머리 방향) 강변 공원. 8시 30분까지 자리 잡아야 정면 뷰 확보. 쇼 시간에 용 머리 근처는 불+물 세례 받으니 우산 또는 우비 필수! 평일 저녁에도 조명 야경은 볼 수 있음.',
                        'lat'         => 16.0610,
                        'lng'         => 108.2270,
                    ],
                ],
