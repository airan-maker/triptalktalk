...
<p>마지막으로 히로시마 시내에서 히로시마 성 야경을 감상하고, 오코노미무라에서 히로시마식 오코노미야키로 여행을 마무리합니다.</p>',
    ...
    // ────────────────────────────────────────────
    // 2. 산보노트 - 마츠야마 (도고온천·우치코·시모나다)
    // ────────────────────────────────────────────
    [
        'title'        => '일본 시코쿠 마츠야마 여행 | 도고온천, 바다 무인역, 슬로우 트래블의 정석',
        'excerpt'      => '센과 치히로의 도고온천, 에도시대 마을 우치코, 시코쿠의 소교토 이요오즈, 그리고 바다 앞 무인역 시모나다까지. 마츠야마를 기점으로 한 서정적인 소도시 여행.',
        'content'      => '<p>마츠야마는 노면전차가 달리는 온천과 성의 도시입니다. 일본에서 가장 오래된 도고 온천은 \'센과 치히로의 행방불명\'의 모티브가 된 곳이며, 시내 중심 산 위의 마츠야마성은 1인용 리프트를 타고 올라가는 재미가 있습니다.</p>
<p>마츠야마역에서 JR을 타고 남쪽으로 내려가면 에도시대 전통 가옥이 보존된 우치코, \'시코쿠의 소교토\'로 불리는 이요오즈를 만납니다. 특히 이요오즈의 가류산장은 강변 벼랑 위에 지어진 다실로, 자연과 건축의 조화가 극에 달한 명소입니다.</p>
<p>여행의 하이라이트는 시모나다역입니다. 플랫폼 바로 앞에 세토 내해가 펼쳐지는 무인역으로, 일몰 시간에 맞춰 방문하면 붉게 물든 바다와 기차가 한 프레임에 담깁니다. 에히메현의 귤 디저트와 도미 요리까지, 교통수단 자체가 여행이 되는 슬로우 트래블의 정석입니다.</p>',
        'youtube_id'   => 'WjvUvd0IrEo',
        'channel_name' => '산보노트',
        'channel_url'  => 'https://www.youtube.com/@sanbonote',
        'duration'     => '',
        'destinations' => [
            ['name' => '일본', 'slug' => 'japan', 'parent' => ''],
            ['name' => '마츠야마', 'slug' => 'matsuyama', 'parent' => 'japan'],
        ],
        'vlog_cats'    => ['감성', '혼자여행'],
        'timeline'     => [
            ['time' => '0:00', 'title' => '마츠야마 도착', 'description' => '노면전차로 시내 이동'],
            ['time' => '3:00', 'title' => '도고 온천 & 하이카라도리', 'description' => '일본 최고(最古) 온천, 봇짱 시계탑, 족욕탕'],
            ['time' => '6:00', 'title' => '마츠야마성', 'description' => '1인용 리프트, 천수각 시내 뷰'],
            ['time' => '9:00', 'title' => '오카이도 상점가', 'description' => '미캉 디저트, 타이메시 맛집'],
            ['time' => '12:00', 'title' => '우치코 마을', 'description' => '에도~메이지 전통 가옥, 우치코좌 가부키 공연장'],
            ['time' => '15:00', 'title' => '이요오즈 & 가류산장', 'description' => '시코쿠의 소교토, 강변 벼랑 위 다실'],
            ['time' => '18:00', 'title' => '오즈성', 'description' => '강가의 아름다운 성곽'],
            ['time' => '20:00', 'title' => '시모나다역 일몰', 'description' => '바다 앞 무인역, 시모나다 커피 트럭'],
        ],
        'spots'        => [
            ['name' => '도고 온천 본관', 'lat' => 33.8520, 'lng' => 132.7874, 'description' => '일본 최고(最古) 온천, 센과 치히로 배경'],
            ['name' => '마츠야마성', 'lat' => 33.8454, 'lng' => 132.7656, 'description' => '1인용 리프트, 천수각 시내 조망'],
            ['name' => '오카이도 상점가', 'lat' => 33.8397, 'lng' => 132.7660, 'description' => '미캉 디저트, 타이메시 맛집 거리'],
            ['name' => '우치코', 'lat' => 33.5438, 'lng' => 132.6475, 'description' => '에도시대 전통 가옥, 목랍 거리'],
            ['name' => '가류산장', 'lat' => 33.5065, 'lng' => 132.5453, 'description' => '강변 벼랑 위 다실, 건축미의 극치'],
            ['name' => '오즈성', 'lat' => 33.5075, 'lng' => 132.5413, 'description' => '강가 성곽, 시코쿠의 소교토'],
            ['name' => '시모나다역', 'lat' => 33.4544, 'lng' => 132.4856, 'description' => '바다 앞 무인역, 일몰 명소'],
        ],
    ],

    // ────────────────────────────────────────────
    // 3. 산보노트 - 일본 소도시 9곳 비교 큐레이션
    // ────────────────────────────────────────────
    [
