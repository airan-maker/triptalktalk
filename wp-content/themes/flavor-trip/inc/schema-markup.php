<?php
/**
 * Schema.org JSON-LD ë§ˆí¬?? * - TouristTrip (?¬í–‰ ?¼ì •)
 * - Article (ë¸”ë¡œê·??¬ìŠ¤??
 * - WebSite + SearchAction (?ˆíŽ˜?´ì?)
 * - BreadcrumbList (ë¹µí¬?¼ì—??ì²˜ë¦¬)
 *
 * @package TripTalk
 */
...
function ft_output_schema_markup() {
    ...
    // ?˜ì´ì§€ë³??¤í‚¤ë§?    if (is_singular('travel_itinerary')) {
