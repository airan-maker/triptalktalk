<?php
/**
 * Remove duplicate/unused languages and their translated posts/terms
 *
 * Run: wp eval-file cleanup-languages.php --allow-root
 *
 * Removes: zh-tw, zh-hk (duplicate Chinese), en-au (duplicate English)
 * Keeps: ko, en, zh-cn, ja, fr, de
 */

$langs_to_remove = ['zh-tw', 'zh-hk', 'en-au'];

echo "=== 중복 언어 정리: zh-tw, zh-hk, en-au 삭제 ===\n\n";
